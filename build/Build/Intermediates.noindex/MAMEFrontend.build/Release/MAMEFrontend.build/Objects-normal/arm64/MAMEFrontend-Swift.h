...
#ifndef MAMEFRONTEND_SWIFT_H
#define MAMEFRONTEND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MAMEFrontend",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSXMLParser;
@class NSString;
/// SAX parser for <code>history.xml</code>:
/// \code
/// <entry>
...
/// </entry>
///
/// \endcodeSoftware-list entries (<code><item .../></code>) are ignored; this targets arcade/system
/// machines matched by short name.
SWIFT_CLASS("_TtC12MAMEFrontend16HistoryXMLParser")
@interface HistoryXMLParser : NSObject <NSXMLParserDelegate>
